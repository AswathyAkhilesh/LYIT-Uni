...
<section class="container spad">
	<form action="file:///C:/Users/Roshni/Desktop/division-blue/validation.html" method="post">
		...
		<input class="accept-button" type="submit" alt="SUBMIT" id="submit-accept" name="Submit" value="Accept"  />
		<input class="decline-button" type="submit" alt="SUBMIT" id="submit-decline" name="Submit" value="Decline"  />
