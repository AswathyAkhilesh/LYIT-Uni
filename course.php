...
<!-- Header End - Do Not Remove -->
      ...
      <div class="container course-details">
         ...
         <ul class="nav nav-tabs">
            <li class="active"><a href="#a"aria-controls="home" role="tab" data-toggle="tab">COURSE DETAILS AND MODULES</a></li>
            <li><a href="#b"aria-controls="home" role="tab" data-toggle="tab" >ENTRY REQUIREMENTS</a></li>
            <li><a href="#c"aria-controls="home" role="tab" data-toggle="tab">COURSE FEE</a></li>
            <li><a href="#d"aria-controls="home" role="tab" data-toggle="tab">HOW TO APPLY</a></li>
            <li><a href="#e"aria-controls="home" role="tab" data-toggle="tab">JOBS</a></li>
         </ul>
         <!-- Tab panes -->
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="a"><br><br><b>Our Master of Science in Computing in DevOps is a one year, full-time or two year, part-time programme. DevOps is the practice of operations and development engineers participating together in the entire service lifestyle, from design through the development process to production support.
            ...
            <div role="tabpanel" class="tab-pane" id="d"><br>Depending on what type of applicant you are, the application process will differ.
